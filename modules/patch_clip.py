...
def patch_all_clip():
    bluemoon.ldm_patched.modules.sd1_clip.ClipTokenWeightEncoder.encode_token_weights = encode_token_weights_fooocus
    ...
    bluemoon.ldm_patched.modules.clip_vision.ClipVisionModel = ClipVisionModelFooocus
    return