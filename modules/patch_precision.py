...
from bluemoon.ldm_patched.ldm.modules.diffusionmodules.util import make_beta_schedule
...
def patch_all_precision():
    bluemoon.ldm_patched.ldm.modules.diffusionmodules.openaimodel.timestep_embedding = patched_timestep_embedding
    bluemoon.ldm_patched.modules.model_sampling.ModelSamplingDiscrete._register_schedule = patched_register_schedule
    return