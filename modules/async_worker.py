...
def worker():
    ...
    import bluemoon.extras.preprocessors as preprocessors
    ...
    def handler(async_task):
        ...
        if bluemoon_expansion in style_selections:
            use_expansion = True
            style_selections.remove(bluemoon_expansion)
        else:
            use_expansion = False
        ...
        if 'cn' in goals:
            ...
            for task in cn_tasks[flags.cn_ip_face]:
                ...
                if not advanced_parameters.skipping_cn_preprocessor:
                    cn_img = bluemoon.extras.face_crop.crop_image(cn_img)
            ...
            try:
                ...
                for x in imgs:
                    d = [
                        ...
                        ('BlueMoon AI V1 Expansion', task['expansion']),
