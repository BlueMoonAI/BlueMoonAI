...
from bluemoon.ldm_patched.contrib.external_custom_sampler import SDTurboScheduler
from bluemoon.ldm_patched.k_diffusion import sampling as k_diffusion_sampling
from bluemoon.ldm_patched.modules.samplers import normal_scheduler, simple_scheduler, ddim_scheduler
from bluemoon.ldm_patched.modules.model_base import SDXLRefiner, SDXL
from bluemoon.ldm_patched.modules.conds import CONDRegular
...
def sample_hacked(model, noise, positive, negative, cfg, device, sampler, sigmas, model_options={}, latent_image=None, denoise_mask=None, callback=None, disable_pbar=False, seed=None):
    ...
    pre_run_control(model, positive)  # negative is not necessary in BlueMoon , 0.5s faster.
    ...
    def refiner_switch():
        ...
        bluemoon.ldm_patched.modules.model_management.load_models_gpu(
...
bluemoon.ldm_patched.modules.samplers.calculate_sigmas_scheduler = calculate_sigmas_scheduler_hacked
bluemoon.ldm_patched.modules.samplers.sample = sample_hacked
