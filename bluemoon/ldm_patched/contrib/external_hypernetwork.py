...
class HypernetworkLoader:
    ...
    def INPUT_TYPES(s):
        return {"required": { "model": ("MODEL",),
                              "hypernetwork_name": (bluemoon.ldm_patched.utils.path_utils.get_filename_list("hypernetworks"), ),
    ...
    def load_hypernetwork(self, model, hypernetwork_name, strength):
        hypernetwork_path = bluemoon.ldm_patched.utils.path_utils.get_full_path("hypernetworks", hypernetwork_name)
