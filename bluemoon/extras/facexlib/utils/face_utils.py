...
if __name__ == '__main__':
    ...
    from bluemoon.extras.facexlib.detection import init_detection_model
    from bluemoon.extras.facexlib.utils.face_restoration_helper import get_largest_face
    from bluemoon.extras.facexlib.visualization import visualize_detection
