...
with shared.gradio_root:
    with gr.Row():
        with gr.Column(scale=2):
            ...
            with gr.Row(elem_classes='type_row'):
                with gr.Column(scale=17):
                    prompt = gr.Textbox(show_label=False, placeholder="Type prompt here or paste the parameters",
            ...
            with gr.Row(visible=False) as image_input_panel:
                with gr.Tabs():
                    with gr.TabItem(label='Upscale or Variation') as uov_tab:
                        with gr.Row():
                            ...
                            with gr.Column():
                                ...
                                gr.HTML(
                                    '<a href="https://github.com/BlueMoonAI/BlueMoonAI/discussions/"  style="color: #fff;" class="button-canvas" target="_blank"> Document</a>')
                    with gr.TabItem(label='Image Prompt') as ip_tab:
                        ...
                        gr.HTML(
                            '* \"Image Prompt\" is powered by BlueMoon AI Image Mixture Engine (v1.0.0). <a href="https://github.com/BlueMoonAI/BlueMoonAI/discussions/"  style="color: #fff;" class="button-canvas" target="_blank"> Document</a>')
        ...
        def preset_selection_change(preset):
            ...
            app.checkpoint_downloads = preset_prepared['checkpoint_downloads']
            app.embeddings_downloads = preset_prepared['embeddings_downloads']
        ...
        prompt.input(parse_meta, inputs=prompt, outputs=[prompt, generate_button, load_parameter_button], queue=False,
                     show_progress=False)
        ...
        gr.update(visible=True, interactive=True), gr.update(visible=True, interactive=True), gr.update(visible=False),
