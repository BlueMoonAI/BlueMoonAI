...
with shared.gradio_root:
            ...
            with gr.Row(visible=False) as image_input_panel:
                with gr.Tabs():
                    with gr.TabItem(label='Upscale or Variation') as uov_tab:
                        with gr.Row():
                            ...
                            with gr.Column():
                                ...
                                gr.HTML('<a href="https://github.com/BlueMoonAI/BlueMoonAI/discussions/" target="_blank">\U0001F4D4 Document</a>')
                    with gr.TabItem(label='Image Prompt') as ip_tab:
                        ...
                        gr.HTML('* \"Image Prompt\" is powered by BlueMoon AI Image Mixture Engine (v1.0.0). <a href="https://github.com/BlueMoonAI/BlueMoonAI/discussions/" target="_blank">\U0001F4D4 Document</a>')
                    ...
                    with gr.TabItem(label='Inpaint or Outpaint') as inpaint_tab:
                        ...
                        gr.HTML('* Powered by BlueMoon AI Inpaint Engine <a href="https://github.com/BlueMoonAI/BlueMoonAI/discussions/" target="_blank">\U0001F4D4 Document</a>')
    ...
    version_html = f"<p style='font-size: 16px; text-align: center;'>BlueMoon AI: v{version}</p>"
