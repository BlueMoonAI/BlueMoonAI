    ...
    with gr.Row():
            ...
            with gr.Row(visible=False) as image_input_panel:
                with gr.Tabs():
                    with gr.TabItem(label='Upscale or Variation') as uov_tab:
                        with gr.Row():
                            ...
                            with gr.Column():
                                ...
                                gr.HTML('<a href="https://github.com/BlueMoonAI/BlueMoonAI/discussions/"  style="color: #fff;" class="button-canvas" target="_blank"> Document</a>')
                    with gr.TabItem(label='Image Prompt') as ip_tab:
                        ...
                        gr.HTML('* \"Image Prompt\" is powered by BlueMoon AI Image Mixture Engine (v1.0.0). <a href="https://github.com/BlueMoonAI/BlueMoonAI/discussions/"  style="color: #fff;" class="button-canvas" target="_blank"> Document</a>')
                    ...
                    with gr.TabItem(label='Inpaint or Outpaint') as inpaint_tab:
                        ...
                        gr.HTML('* Powered by BlueMoon AI Inpaint Engine (v1.0.0) <a href="https://github.com/BlueMoonAI/BlueMoonAI/discussions/"  style="color: #fff;" class="button-canvas" target="_blank"> Document</a>')
                    ...
                    with gr.TabItem(label='Describe') as desc_tab:
                        with gr.Row():
                            ...
                            with gr.Column():
                                ...
                                gr.HTML('<a  style="color: #fff;"  href="https://github.com/BlueMoonAI/BlueMoonAI/discussions/" class="button-canvas" target="_blank"> Document</a>')
        ...
        with gr.Column(scale=1, visible=modules.config.default_advanced_checkbox) as advanced_column:
            with gr.Tab(label='Setting'):
                ...
                if not args_manager.args.disable_image_log:
                    gr.HTML(f'<a  style="color: #fff;"  href="/file={get_current_html_path()}" class="button-canvas" target="_blank"> History Log</a>')
                ...
                with gr.Column(visible=False) as dev_tools:
                    with gr.Tab(label='Debug Tools'):
                        ...
                        adaptive_cfg = gr.Slider(label='CFG Mimicking from TSNR', minimum=1.0, maximum=30.0, step=0.01,
                                                 ...
                                                 info='Enabling BlueMoon AI\'s implementation of CFG mimicking for TSNR '
                    ...
                    with gr.Tab(label='Inpaint'):
                        ...
                        inpaint_engine = gr.Dropdown(label='Inpaint Engine',
                                                     ...
                                                     info='Version of BlueMoon AI inpaint model')
        ...
        def trigger_describe(mode, img):
            if mode == flags.desc_type_photo:
                ...
                return default_interrogator_photo(img), ["BlueMoonAI V1", "Enhance", "Sharp"]
            if mode == flags.desc_type_anime:
                from bluemoon.extras.wd14tagger import default_interrogator as default_interrogator_anime
                return default_interrogator_anime(img), ["BlueMoonAI V1", "Masterpiece"]
            return mode, ["BlueMoonAI V1"]
